...
public class AddamsFamilyApplication {
        ...
        ********************************************************************************************/
        ...
        /********************************************************************************************
         * List of the Addams Family members for the application
         ********************************************************************************************/
        ...
        /********************************************************************************************
         * Application controller - like the main() for this specific application
         ********************************************************************************************/
 ...
 *********************************************************************************************************/
        ...
        ********************************************************************************************/
        public String displayMenuAndGetResponse() {
                ...
                // NOTE: You CANNOT use an Iterator on a simple array - only Collections class objects have Itertors
        ...
        ********************************************************************************************/
        public void startOfApplicationProcessing() throws FileNotFoundException{
                ...
                // redirect error messages (exception messages) to a file rather than the screen
        ...
        public void displayAllPeople() {
                ...
                // for (Person anAddams : theAddamsFamily) {  // replaced with an Iterator
                // Instantiate an iterator for the Collection class object
                //  class of objects in the collection  =    collection object name.iterator()
                Iterator<Person> allPeopleIterator      =    theAddamsFamily.iterator();
                while(allPeopleIterator.hasNext()) {
                    Person anAddams = allPeopleIterator.next();  // Use iterator to get the next element
                    personCount++;
        ...
        public void displayByName() {
                ...
                //      for(int i = 0; i < listOfAddams.size(); i++)  // i is teh iterator - holds the current location in the array
                //         listOdAddams[i]   // get the element at index i
                //      An Iterator is like the int i in an Iterotor
                // An Iterator is position BEFORE the first element
                Iterator<Person> personIterator = listOfAddams.iterator();   // instantiate an iterator for teh Collections object
        ...
        public void removeAnAddams() {
                ...
                Iterator<Person> addamsIttertor = aListOfAddams.iterator();
                while(addamsIttertor.hasNext()) {
                        Person anAddams = addamsIttertor.next();
                        ...
                        if (deleteResponse.startsWith("Y")) {             // If user wants to delete entry...
                                if (theAddamsFamily.remove(anAddams)) {   //    remove it from the data structure
                                    addamsIttertor.remove();              //       and from the extracted entries using Itertor
        ...
        private void loadFamilyMembersFromFile() throws FileNotFoundException, DataFileErrorException {
                ...
                try {
                        ...
                        // hasNextLine() is an Itertor for Scanner objects
                        ...
                        memberFileReader.close();  // File needs to be closed in case a reload of file is requested
                                                   // If its not closed, ir emains open and a reload would cause
                                                   //    an exception as it would try to open it again
                                                   //    or some other undesirable would occur
                }
        }  // End of loadMembers()
        ...
        public List<Person>findAnAddamsByName(String requestedPersonName, boolean isCaseSensitive) {
                List<Person> foundPeople = new ArrayList<>();            // Hold entry(ies) found in application data structire
        ...
        public void displayAllInReverseOrder() {
                ...
                while(personListIterator.hasPrevious()) {
                        Person anAddams = personListIterator.previous();
                        System.out.println(anAddams);
                }
        ...
        public void addANewAddams() {
                ...
                // if repsonse was entered, check the first character and set after indicator
