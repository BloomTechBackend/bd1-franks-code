...
public class PasswordUtil {
    ...
    // Files used by  the processing
    // Available file pairs in resources folder:
    //    Passwords-to-crack      ----   Hashed-passwords
    //   ----------------------          -----------------------------
    //   commonPasswords100.csv   ----   hackedDatabase100x10x190.csv
    //   commonPasswords1K.csv    ----   hackedDatabase1Kx100x1900.csv
    //   commonPasswords10K.csv   ----   hackedDatabase10Kx1Kx19K.csv

    private static final String COMMON_PASSWORD_FILE = "commonPasswords100.csv";        // Passwords to crack
    private static final String HACKED_DATABASE_FILE = "hackedDatabase100x10x190.csv";  // File containing hashed passwords
