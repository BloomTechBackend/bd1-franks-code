...
public class ModifyReservationActivity {
     ...
     * Update the ReservationRevenue metric with the difference between original reservation revenue and modified reservation
     *
    ...
    public UpdatedReservation handleRequest(final String reservationId, final ZonedDateTime checkInDate,
       ...
       // Update the reservation in the data store
        ...
        // calculate the difference between the cost of the original reservation and the modified reservation
        ...
        // Store the ReservationRevenue metric using the diference in cost
