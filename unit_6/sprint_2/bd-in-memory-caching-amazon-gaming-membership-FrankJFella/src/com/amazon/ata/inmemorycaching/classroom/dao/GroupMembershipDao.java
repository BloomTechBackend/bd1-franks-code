...
public class GroupMembershipDao {
    ...
    // Provide an isUserInGroup method to receive a cache key for the application]
    //     call to implement caching
    public boolean isUserInGroup(GroupMembershipCacheKey key) {
        // Use the original DAO method when cache manager DAO need to get data
        // This is NOT a recursive call due to the method signature difference (2 Strings)
