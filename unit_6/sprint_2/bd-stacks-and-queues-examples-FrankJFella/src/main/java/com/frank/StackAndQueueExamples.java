...
//                               new Stack(); - OK too
		...
		//       the for-each processes the element in entry order
		//       NOT the normal LIFO order of a Stack
		...
		// get() using entry sequence for Stack NOT the LIFO sequence
 ...
 *  .poll()           - Retrieve the top element and remove it
 *  .remove()         - same as poll()
 *  .peek()           - return top element without removing it
 ...
 **********************************************************************************/
		...
		itemNum = 0;
		// for-each with a Queue processes the elements in entry sequence - like you expect
		//          for-each does NOT remove elements from the queue (it peeks() them
		...
		System.out.println("--------------------------------------------");
		System.out.println("Adding and removing of of the Three Stooges");

		myQueue.add("Moe Howard");
		System.out.println("--------------------------------------------");

		myQueue.remove("Moe Howard");
		System.out.println("    Number items in myQueue - .size(): " + myQueue.size());
